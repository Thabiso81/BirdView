...
import com.birdview.app.adapters.BirdListAdapter
import com.birdview.app.api_interfaces.EBirdApiService
import com.birdview.app.api_interfaces.FlickrService
import com.birdview.app.api_interfaces.XenoCantoService
import com.birdview.app.models.Bird
import com.birdview.app.models.BirdWithImage
...
//        }
        ...
        cardViewUnidentified.setOnClickListener{
            val childFragment = com.birdview.app.UnidentifiedDialogFragment(
                currentLatLng.latitude.toString(),
                currentLatLng.longitude.toString(),
                tripId
            )
            childFragment.show(fragmentManager, com.birdview.app.UnidentifiedDialogFragment::class.java.simpleName)
        }

        cardViewManualEntry.setOnClickListener(){
            val childFragment = com.birdview.app.BirdManualEntryDialogFragment(
                currentLatLng.latitude.toString(),
                currentLatLng.longitude.toString(),
                tripId
            )
            childFragment.show(fragmentManager, com.birdview.app.BirdManualEntryDialogFragment::class.java.simpleName)
        }
    ...
    fun checkLocationPermissions() {
        if (ContextCompat.checkSelfPermission(this.requireContext(), android.Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            requestPermissions(arrayOf(android.Manifest.permission.ACCESS_FINE_LOCATION),
                com.birdview.app.AddSightingFragment.Companion.REQUEST_LOCATION_PERMISSION
            )
        } else {
...
//                    ).show()
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        if (requestCode == com.birdview.app.AddSightingFragment.Companion.REQUEST_LOCATION_PERMISSION) {
